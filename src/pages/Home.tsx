...
// export default Home;import { useInView } from "react-intersection-observer";
import {
  ChevronRight,
  Wind,
  Box,
  ...
  const reviews = [
    {
      name: "Aarav Mehta",
      review:
        "They helped us redesign our HVAC system—very knowledgeable team!",
      rating: 5,
    ...
    },
    {
      name: "Emily Johnson",
      review:
        "Great product design support. They went above and beyond expectations.",
      rating: 4,
      location: "Austin, TX",
      date: "May 22, 2025",
      style: "Custom Machinery",
      helpful: 5,
    },
    {
      name: "Ravi Sharma",
      review:
        "FEA reports were precise and delivered right on schedule. Highly recommended!",
      rating: 5,
      location: "Pune, India",
      date: "April 30, 2025",
      style: "Structural FEA",
      helpful: 9,
    },
    {
      name: "Lena Fischer",
      review:
        "Reverse engineering support was solid, but communication can improve slightly.",
      rating: 4,
            ...
            {[
              {
                ...
                title: "HVAC Design & Drafting",
                description:
                  "Customized HVAC design and drafting solutions for your needs.",
              },
              {
                icon: <Box className="w-12 h-12 text-blue-600" />,
                title: "Product Design",
              ...
              },
              {
                ...
                title: "Reverse Engineering",
                description:
                  "Precise reverse engineering and re-design services.",
              },
              {
                icon: <Layers className="w-12 h-12 text-blue-600" />,
                title: "FEA (Finite Element Analysis)",
                description:
                  "Advanced Finite Element Analysis for structural integrity.",
              },
              {
                icon: <Package className="w-12 h-12 text-blue-600" />,
                title: "Custom 3D Prototyping",
                description:
                  "High-quality 3D prototyping tailored to your requirements.",
              },
              {
                icon: <LayoutDashboard className="w-12 h-12 text-blue-600" />,
                title: "DFM & DFMA Drawings",
                description:
                  "Detailed DFM & DFMA drawings for efficient manufacturing.",
              },
              {
                icon: <Hammer className="w-12 h-12 text-blue-600" />,
                title: "Lean Manufacturing Consulting",
                description:
                  "Optimize processes with our Lean Manufacturing expertise.",
              },
              {
                icon: <Repeat className="w-12 h-12 text-blue-600" />,
                title: "BIM Services",
                description:
                  "Building Information Modeling for construction projects.",
              },
              {
                icon: <Layers className="w-12 h-12 text-blue-600" />,
                title: "Software Training",
                description:
                  "Specialized training on engineering and CAD software.",
              },
            ].map((service, index) => (
              <motion.div
                key={index}
          ...
          <Slider {...reviewCarouselSettings}>
            {reviews.map((review, index) => (
              <div key={index} className="px-3">
                <div className="p-6 bg-white text-gray-800 rounded-xl shadow-lg border border-gray-200 min-h-[18rem] flex flex-col justify-between">
                  {/* Header */}
                  ...
                  <div className="flex items-center mb-1">
                    ...
                    <h3 className="ml-2 font-bold text-base text-gray-900">
                      Excellent Service
                    </h3>
                  </div>
